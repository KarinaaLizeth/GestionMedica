        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="route('colaboradores.index')" :active="request()->routeIs('colaboradores.index')" class="text-black active-nav-link">
                        {{ __('Colaborador') }}
                    </x-nav-link>
                    @php
                        ...
                        <ul class="divide-y divide-gray-200">
                            @forelse($notificaciones as $notificacion)
                                <li class="p-2 hover:bg-gray-100">
                                    <form action="{{ route('notificaciones.leer', ['id' => $notificacion->id]) }}" method="POST" style="display: inline;">
                                        @csrf
                                        <button type="submit" class="text-sm text-gray-700 hover:no-underline">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-blackfocus:outline-none transition ease-in-out duration-150" style="background-color: #83c5be !important; coloblack!important; margin-left: 0px;" onmouseout="this.style.backgroundColor='#83c5be'">
                            <div>
                                {{ Auth::user()->name }}
                            </div>
                            <div class="ml-1">
