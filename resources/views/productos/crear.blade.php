...
@section('content')
<form class="max-w-sm mx-auto" method="POST" action="{{ route('productos.store') }}">
    @csrf
    <div class="mb-5">
    ...
    <div class="mb-5">
        ...
        <input type="number" id="cantidad" name="cantidad" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" required />
    </div>
    <div class="mb-5">
