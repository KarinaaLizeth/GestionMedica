                            ...
                            @foreach($consulta->recetas as $index => $receta)
                                <div class="receta-field-group flex w-full gap-4">
                                    ...
                                    <div class="flex-1 flex items-center">
                                        <button type="button" class="remove"><ion-icon name="remove-outline"></ion-icon></button>
                                    </div>
                                </div>
                            @endforeach
                        </div>
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <select id="servicio" name="servicio[]" class="input-field servicio-select" required>
                                            ...
                                            @foreach($servicios as $servicio)
                                                <option value="{{ $servicio->id }}" @if($servicio->id == $servicioConsulta->servicio_id) selected @endif>{{ $servicio->nombre }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="flex-1">
                                        <label for="cantidad_servicio">Cantidad</label>
                                        <input type="number" id="cantidad_servicio" name="cantidad_servicio[]" value="{{ $servicioConsulta->cantidad_servicio }}" class="input-field"/>
                                    </div>
                                    <div class="flex-1">
