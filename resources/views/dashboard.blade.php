<x-app-layout>
  <div>
      ...
      <div class="md:overflow-hidden"style="background-color: #DAFFEF;">
        <div class="px-4 py-20 md:py-4">
          <div class="md:max-w-6xl md:mx-auto">
            <div class="md:flex md:flex-wrap">
              <div class="md:w-1/2 text-center md:text-left md:pt-16">
                <h1 class="font-bold text-black text-2xl md:text-5xl leading-tight mb-4" style="font-family: Poppins">
                  Health Plus
                </h1>

                <p class="md:text-xl md:pr-48" style="color: #247b7b">
                Nos complace darle la bienvenida a nuestro sistema médico. Aquí podrá gestionar toda la información y servicios relacionados con su salud de manera eficiente y segura. Si necesita ayuda, no dude en contactarnos. ¡Gracias por confiar en nosotros!
                </p>

                <a
                  href="#"
                  class="mt-6 mb-12 md:mb-0 md:mt-10 inline-block py-3 px-8 text-white rounded-lg shadow" style="background-color: #247b7b;"
                  >Bienvenida</a
                >
              </div>
              <div class="md:w-1/2 relative">
                <div class="hidden md:block">
                  <div class="-ml-24 -mb-40 absolute left-0 bottom-0 w-40 bg-white rounded-lg shadow-lg px-6 py-8" style="transform: rotate(-8deg);">
                    <div class="mx-auto rounded-lg px-2 pb-2 relative mb-8">
                  ...
                  <div class="ml-24 mb-16 absolute left-0 bottom-0 w-40 bg-white rounded-lg shadow-lg px-6 py-8" style="transform: rotate(-8deg); z-index: 2;">
                    <div class="mx-auto rounded-lg relative mb-8 py-2 w-20 border-2 border-white">
