...
<nav x-data="{ open: false }" class="navbar from-blue-500 via-blue-600 to-blue-700 text-white shadow-lg">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="route('productos.index')" :active="request()->routeIs('productos.index')" class="text-white hover:text-gray-300">
                        {{ __('Productos') }}
                    </x-nav-link>
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-white focus:outline-none transition ease-in-out duration-150" style="background-color: #247b7b !important; color: white !important;" onmouseover="this.style.backgroundColor='#508f8a'" onmouseout="this.style.backgroundColor='#247b7b'">
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('doctores.crear')" :active="request()->routeIs('doctores.crear')" class="text-white hover:bg-blue-700">
                {{ __('Agregar Doctor') }}
            </x-responsive-nav-link>
        </div>
