...
class CitasController extends Controller
{
    ...
    */
    ...
    public function getHorariosDisponibles(Request $request)
    {
        ...
        $diaSemana = $dias[$diaSemana];
        //consulta en la base de datos para obtener los horarios del doctor identificado por su id
        ...
        //obtener las horas reservadas en la fecha seleccionada filtrando por citas en proceso
        $citasReservadas = Citas::where('doctor_id', $doctorId)
                                 ->where('fecha', $fecha)
                                 ->whereIn('estado', ['En proceso'])
                                 ->pluck('hora') //extrarer la hora
                                 ->toArray(); //convertirlo en un array
    
        return response()->json([
            'horarios' => $horariosDisponibles,
            'duracion_cita' => $doctor->duracion_cita,
            'citasReservadas' => $citasReservadas
        ]);
    }
